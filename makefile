...
EXPORTED_FUNCS = '["_add_image", "_process_images_with_progress", "_get_final_results", "_get_partial_results", "_get_total_images", "_get_processed_count", "_clear_images", "_malloc", "_free"]'
